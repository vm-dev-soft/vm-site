...
jQuery(document).ready(function(){
  jQuery('a.head').click(function(e) {
      ...
      jQuery('html,body').animate({ scrollTop: jQuery(this.hash).offset().top - jQuery('#header').height()}, 1000);
...
(function() {
  jQuery(document).ready(function() {
    ...
    return $('a#send-mail').click(function(e) {
      var company, email, messages, name, phone;
      name = $('#name').val();
      email = $('#email').val();
      phone = $('#phone').val();
      company = $('#company').val();
      ...
      if (name === "" && messages === "" && email === "") {
        return alert("Please make sure name, email and messages was not blank");
        ...
        return alert('Please make sure email was not wrong type');
      }
    });
  });
